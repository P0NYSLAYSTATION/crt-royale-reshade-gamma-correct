...
Old games that do not use an encoding standard are usually closer to BT.1886 or pure power-law, so either decode BT.1886 or use the linear encode and decode.
